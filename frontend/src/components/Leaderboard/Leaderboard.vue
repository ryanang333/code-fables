<template>
  <div class="bg-image p-4">
    <div class="bg-overlay p-5"></div>

    <div class="container">
      <div
        class="container"
        style="position: fixed; left: 0px; top: 80px; z-index: 999"
      >
        <button
          @click="friendBool"
    ...
    <div class="container mt-5 podium-div" v-if="leaderboardPodium.length == 3">
      <h2 class="text-center">
        <img
          class="w-100"
          src="/assets/images/global-leaderboard.png"
          v-if="friendsBool == false"
        />
      </h2>
      <div class="mt-4 row justify-content-center">
        <div class="col-lg-3 col-md-12 order-lg-1 order-2 mt-5 text-center">
          <img class="podium" src="/assets/images/king.png" />
          <div
        ...
        >
          <img class="podium" src="/assets/images/premium.png" />
          <div
            class="card podiumBack shadow d-flex flex-direction-column justify-content-center align-items-center"
            v-bind:style="{
              backgroundColor:
        ...
        >
          <img class="podium" src="/assets/images/crown.png" />
          <div
            class="card podiumBack shadow d-flex flex-direction-column justify-content-center align-items-center"
            v-bind:style="{
              backgroundColor:
    ...
    <div class="container mt-5">
      <h2 class="text-center">
        <img
          class="w-100"
          src="/assets/images/friends-leaderboard.png"
          v-if="friendsBool == true"
        />
      </h2>
      ...
      >
        <div
          ...
          v-bind:style="{
            backgroundColor:
              person.email == this.myUser ? 'lightgoldenrodyellow' : '#cdbea2',
            borderColor: person.email == this.myUser ? '#00AEEF ' : '#7e6e5c',
            boxShadow:
              person.email == this.myUser ? '0 0 30px 5px #48abe0' : '',
          }"
        >

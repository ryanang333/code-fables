  ...
  <div class="container">
    <div id="carouselExample" class="carousel slide">
      <div class="carousel-inner">
        <div class="textbox bg-dark fw-bold text-white">
          Use mouse controls to inspect your character!
        </div>
        <div
